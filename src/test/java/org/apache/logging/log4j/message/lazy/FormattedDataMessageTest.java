...
public class FormattedDataMessageTest {
  ...
  void testFullMessageSubstitutesData() {
    String[] formats = {"FULL"};
    assertThat(
        message.getFormattedMessage(formats),
        is(
            equalTo(
                "a_message_type [a_message_id a=\"aVal\" b=\"bVal\" c=\"cVal\"] This is a message. a=aVal b=bVal")));
  }
  ...
  void testStructuredOnlyMessageOmitsMessage() {
    ...
    assertThat(
        message.getFormattedMessage(formats),
        is(equalTo("[a_message_id a=\"aVal\" b=\"bVal\" c=\"cVal\"]")));
  }
  ...
  void testJsonDoesNotInterpolate() {
    ...
    assertThat(
        ...
        is(
            equalTo(
                "{\"type\":\"a_message_type\", \"id\":\"a_message_id\", \"message\":\"This is a message. a=%(a) b=%(b)\", \"a\":\"aVal\", \"b\":\"bVal\", \"c\":\"cVal\"}")));
  }
    ...
    try {
      ...
      logger.info(
          new FormattedDataMessage(
              ...
              "some_message_type",
              Map.ofEntries(entry("a", "aVal"), entry("b", "bVal"), entry("c", "cVal"))),
          e);
    }
  }
}
